<?php get_header(); ?>
  ...
  <section style="position:relative;overflow:hidden;max-width:1280px;margin:0 auto;padding:46px 44px 24px">
    ...
    <div style="position:relative;max-width:720px">
      <div style="font:700 16px Manrope;letter-spacing:.18em;text-transform:uppercase;color:#F26A12">Carrosserie · Aigle</div>
      <h1 style="font:800 58px/0.98 Archivo;letter-spacing:-.025em;margin:18px 0 0">Carrosserie à Aigle</h1>
      <p style="font:400 19px/1.6 Manrope;color:#5E5C57;margin:20px 0 0">Réparation carrosserie, peinture et esthétique automobile à Aigle et dans le Chablais. Un travail soigné, des délais courts et un accueil qui change tout.</p>
  ...
  <!-- TEXTE SEO + SERVICES -->
  <section style="max-width:1280px;margin:0 auto;padding:12px 20px 24px">
    <div style="display:flex;flex-wrap:wrap;gap:46px">
      <div style="flex:1 1 440px;min-width:320px">
        <h2 style="font:800 30px/1.1 Archivo;letter-spacing:-.02em;margin:0 0 16px">Votre carrossier de confiance, proche de Aigle</h2>
        <p style="font:400 17px/1.7 Manrope;color:#5E5C57;margin:0 0 14px">Situés au Chemin de St-Triphon 22 à Aigle, nous intervenons sur tous types de véhicules : réparation de chocs, débosselage, peinture, esthétique et entretien auto et bateau. Devis gratuit et prise en charge rapide.</p>
      ...
      <div style="flex:1 1 360px;min-width:300px;height:300px;border-radius:18px;overflow:hidden;border:1px solid #ece7de">
        <iframe title="Carte" src="https://www.google.com/maps?q=Chemin+de+St-Triphon+22,+1860+Aigle&output=embed" style="border:0;width:100%;height:100%;display:block;filter:grayscale(0.15)" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </div>
  </section>
  ...
  <section style="max-width:1280px;margin:30px auto 60px;padding:0 44px">
    <div class="neo-band-dark" style="background:linear-gradient(115deg,#05192b,#0a3050 55%,#114061);color:#fff;border-radius:24px;padding:50px 50px;display:flex;flex-wrap:wrap;align-items:center;gap:28px;justify-content:space-between">
      <div style="flex:1 1 420px;min-width:300px">
        <h2 style="font:800 32px/1.1 Archivo;letter-spacing:-.02em;margin:0;max-width:560px">Un dégât à Aigle ? Appelez, on vous conseille.</h2>

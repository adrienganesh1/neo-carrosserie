...
})(window,document,'script','dataLayer','GTM-WF6FF98R');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WF6FF98R"
...
<?php endforeach; ?>
  ...
  <header style="position:relative;z-index:5;max-width:1280px;margin:0 auto;padding:26px 44px;display:flex;flex-wrap:wrap;align-items:center;gap:18px 36px">
    <a href="<?php echo esc_url(home_url("/")); ?>" style="display:flex;align-items:center;gap:12px;text-decoration:none">
      <img src="/wp-content/themes/neo-carrosserie/assets/logo-neo.svg" alt="NEO Carrosserie Aigle" width="517" height="169" style="height:84px;width:auto;display:block">
    </a>
    ...
    <nav id="neo-nav" style="display:flex;flex-wrap:wrap;align-items:center;justify-content:flex-start;gap:12px 15px;flex-basis:100%;order:2">
      <div class="neo-hasdrop" style="position:relative;display:inline-block">
        ...
        <div class="neo-drop" style="position:absolute;top:100%;left:0;padding-top:12px;z-index:20;display:none">
          <div style="background:#fff;border:1px solid #ece7de;border-radius:12px;box-shadow:0 16px 40px rgba(5,25,43,.14);padding:8px;min-width:240px">
            ...
            <a href="/pose-pneus/" data-i18n="nav.posepneus" style="display:block;text-decoration:none;color:#3d3b36;font:600 14px Manrope;padding:9px 12px;border-radius:8px">Pose de pneus</a>
          </div>
        </div>
      </div>

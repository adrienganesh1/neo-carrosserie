      ...
      <div style="flex:1 1 280px;min-width:260px">
        ...
        <div style="margin-top:22px">
          ...
          <div class="neo-soc-row" style="display:flex;gap:10px;flex-wrap:wrap">
            <a class="neo-soc" href="https://www.facebook.com/people/Neo-Carrosserie/61591973637361/" target="_blank" rel="noopener" aria-label="Facebook" title="Facebook"><svg width="19" height="19" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.99 3.66 9.13 8.44 9.88v-6.99H7.9V12h2.54V9.8c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99C18.34 21.13 22 16.99 22 12z"/></svg></a>

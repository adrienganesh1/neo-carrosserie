    ...
    <div class="neo-foot-grid" style="max-width:1280px;margin:0 auto;padding:64px 44px 30px">
      <div style="flex:1 1 280px;min-width:260px">
        <div style="margin-bottom:18px">
          <img src="/wp-content/themes/neo-carrosserie/assets/logo-neo-white.svg" alt="NEO Carrosserie Aigle" width="517" height="169" style="height:66px;width:auto;display:block">
        </div>
